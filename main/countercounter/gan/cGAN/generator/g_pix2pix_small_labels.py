...
class GPix2PixSmallLabels(nn.Module):

    def __init__(self, in_channels=1, out_channels=1, input_size=128, use_conv2dtranspose=True, upsample_mode='nearest', n_classes=2):
        super().__init__()
        ...
        self.emb_size = 8
        self.emb_layer = nn.Embedding(self.n_classes, self.emb_size * self.emb_size)
        ...
        self.d4, self.d4_act = self.decoder_block(1024, 256)
        self.d5, self.d5_act = self.decoder_block(512, 128)
