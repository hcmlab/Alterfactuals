from main.countercounter.classifier.evaluation.TestDistributionEvaluator import TestDistributionEvaluator
...
class TestActivationEvaluationPipeline:
    ...
    def run(self, config_nr, root_dir, config_dir, checkpoint, path_to_dataset=None, path_to_output_folder=None):
        ...
        TestDistributionEvaluator(setup, path_to_output_folder).evaluate()