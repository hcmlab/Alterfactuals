...
class DataSetMNISTIdentified(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.in_memory:
            ...
            return self._load_image(self.filename_by_index[idx]), self.get_label(self.filename_by_index[idx]), self.filename_by_index[idx]
    ...
    def _initialize(self) -> None:
        ...
        for idx, filename in enumerate(os.listdir(data_dir)):
            ...
            if self.in_memory:
                self.data.append((self._load_image(complete_filename), self.get_label(complete_filename), self.filename_by_index[idx]))
