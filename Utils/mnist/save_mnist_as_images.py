...
mnist_train = datasets.MNIST(root='/files/', train=True, download=True, transform=None)
mnist_test = datasets.MNIST(root='/files/', train=False, download=True, transform=None)
